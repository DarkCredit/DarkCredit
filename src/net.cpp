...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("DarkCredit-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DarkCredit " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"darkcredit.net", "dcxnode2.ddns.net"}, //Main DarkCredit Seed Node
    {"dcxnode.ddns.net", "dcxnode2.ddns.net"}, //BackUp DarkCredit Seed Node
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("DarkCredit-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DarkCredit-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("DarkCredit-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DarkCredit-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DarkCredit is probably already running."), addrBind.ToString().c_str());
        else
